...
class ComgatePaymentsSimpleProtocol {
     ...
     *      payer identifier
     * @param string $vatPL
     *        one of VATs PL from Comgate Payments system
     ...
     *      Identifier of Merchant’s bank account to which Comgate transfers the money.
     *      If the parameter is empty, the default Merchant’s account will be used.
     *      List of accounts is on https://portal.comgate.cz/
     * @param string $email
